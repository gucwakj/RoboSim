	...
	for (int i = topLeft.row(); i <= bottomRight.row(); i++) {
		...
		switch (preconfig) {
			...
			case rsLinkbot::Preconfigs::FourBotDrive: {
				...
				robot2->drawConnector(sceneRobot2, rsLinkbot::Connectors::Simple, rsLinkbot::Bodies::Face3, rs::Right, 0, 1, rsLinkbot::Connectors::SmallWheel);
				...
				robot3->drawConnector(sceneRobot3, rsLinkbot::Connectors::Simple, rsLinkbot::Bodies::Face3, rs::Right, 0, 1, rsLinkbot::Connectors::SmallWheel);
			...
			case rsLinkbot::Preconfigs::Snake: {
				...
				robot0->draw(sceneRobot0, p, q, rs::Vec(0, 0, 0), c, 0);
				robot0->drawConnector(sceneRobot0, rsLinkbot::Connectors::Bridge, rsLinkbot::Bodies::Face1, rs::Left, 0, 1, -1);
				robot0->drawConnector(sceneRobot0, rsLinkbot::Connectors::Simple, rsLinkbot::Bodies::Face2, rs::Right, 0, 1, -1);
				robot0->drawConnector(sceneRobot0, rsLinkbot::Connectors::Simple, rsLinkbot::Bodies::Face2, rs::Right, 0, 2, rsLinkbot::Connectors::Caster);
				robot0->drawConnector(sceneRobot0, rsLinkbot::Connectors::Bridge, rsLinkbot::Bodies::Face3, rs::Right, 0, 1, -1);
