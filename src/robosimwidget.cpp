...
roboSimWidget::roboSimWidget(QWidget *parent) : QWidget(parent) {
	...
	names.clear();
	icons.clear();
	names << "Arc" << "Arc Sector" << "Arc Segment" << "Arrow" << "Circle" << "Ellipse" << "Line" << "Point" <<  "Polygon" << "Quad" << "Rectangle" << "Star" << "Text" << "Triangle";
	icons << ":/icons/arc128.png" << ":/icons/arcsector128.png" << ":/icons/arcsegment128.png" << ":/icons/arrow128.png" << ":/icons/circle128.png" << ":/icons/ellipse128.png" << ":/icons/line128.png" << ":/icons/point128.png" << ":/icons/polygon128.png" << ":/icons/quad128.png" << ":/icons/rectangle128.png" << ":/icons/star128.png" << ":/icons/text128.png" << ":/icons/triangle128.png";
	...
	QTreeWidgetItem *rc17 = new QTreeWidgetItem(ui->tree_challenges);
	rc17->setText(0, "2017");
	rc17->setText(1, "2017 RoboPlay Challenges");
	QTreeWidgetItem *rc17div1 = this->build_challenge_folder(rc17, "Division 1", "");
	this->build_challenge(rc17div1, "Pythagoreans Coordinates", "30 points");
	this->build_challenge(rc17div1, "Message for the Pentagon", "35 points");
	this->build_challenge(rc17div1, "Roundabout", "40 points");
	this->build_challenge(rc17div1, "Emergency Intercept", "45 points");
	this->build_challenge(rc17div1, "Search Party", "50 points");
	this->build_challenge(rc17div1, "Ambulance Selector", "60 points");
	this->build_challenge(rc17div1, "Heartbeat", "65 points");
	this->build_challenge(rc17div1, "Go Robobo2", "70 points");
	this->build_challenge(rc17div1, "Supply Transfer", "80 points");
	this->build_challenge(rc17div1, "Helpful Friend", "100 points");
	QTreeWidgetItem *rc17div2 = this->build_challenge_folder(rc17, "Division 2", "");
	this->build_challenge(rc17div2, "Supply Drop", "30 points");
	this->build_challenge(rc17div2, "Roundabout", "40 points");
	this->build_challenge(rc17div2, "Emergency Intercept", "40 points");
	this->build_challenge(rc17div2, "Ambulance Selector", "50 points");
	this->build_challenge(rc17div2, "Search Party", "60 points");
	this->build_challenge(rc17div2, "Heartbeat", "65 points");
	this->build_challenge(rc17div2, "Go Robobo2", "70 points");
	this->build_challenge(rc17div2, "Supply Transfer", "80 points");
	this->build_challenge(rc17div2, "Helpful Friend", "100 points");
	this->build_challenge(rc17div2, "Lost", "120 points");
	QTreeWidgetItem *rc17div3 = this->build_challenge_folder(rc17, "Division 3", "");
	this->build_challenge(rc17div3, "Broken Traffic Light", "30 points");
	this->build_challenge(rc17div3, "A Quadratic Confusion", "35 points");
	this->build_challenge(rc17div3, "Emergency Intercept", "40 points");
	this->build_challenge(rc17div3, "Message for the Pentagon", "45 points");
	this->build_challenge(rc17div3, "Ambulance Selector", "50 points");
	this->build_challenge(rc17div3, "Search Party", "60 points");
	this->build_challenge(rc17div3, "Supply Transfer", "70 points");
	this->build_challenge(rc17div3, "Go Robobo2", "80 points");
	this->build_challenge(rc17div3, "Helpful Friend", "100 points");
	this->build_challenge(rc17div3, "Lost", "120 points");
	...
	ui->tree_challenges->expandItem(rc17);
	ui->tree_challenges->expandItem(rc17div1);
	ui->tree_challenges->expandItem(rc17div2);
	ui->tree_challenges->expandItem(rc17div3);
	...
	ui->tree_challenges->collapseItem(rc17div1);
	ui->tree_challenges->collapseItem(rc17div2);
	ui->tree_challenges->collapseItem(rc17div3);
...
void roboSimWidget::addItem(QListWidgetItem *item) {
	...
	else if (!item->text().compare("Star"))
		_obj_model->addObject(rs::Star);
