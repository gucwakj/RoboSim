...
roboSimWidget::roboSimWidget(QWidget *parent) : QWidget(parent) {
	...
	names.clear();
	icons.clear();
	names << "Bow" << "Four Bot Drive" << "Four Wheel Drive" << "Group Bow" << "Inchworm" << "Lift" << "Stand";
	icons << "icons/bow128.png" << "icons/fourbotdrive128.png" << "icons/fourwheeldrive128.png" << "icons/groupbow128.png" << "icons/inchworm128.png" << "icons/lift128.png" << "icons/stand128.png";
