...
class arcSectorEditor : public QWidget {
		Q_OBJECT
	public:
		arcSectorEditor(objectModel*, QWidget* = 0);
		void setIndex(int);
		void setUnits(bool);
...
class arrowEditor : public QWidget {
		Q_OBJECT
	public:
		arrowEditor(objectModel*, QWidget* = 0);
		void setIndex(int);
		void setUnits(bool);
...
class quadEditor : public QWidget {
		Q_OBJECT
	public:
		quadEditor(objectModel*, QWidget* = 0);
		void setIndex(int);
		void setUnits(bool);
